...
A good service discovery mechanism will provide you with _metadata_. Metadata is what you will convert into target labels, and generally the more metadata you have, the better.
...
- Using relabelling to specify your target labels: _replace action_ - allows you to copy labels around, while also applying regular expressions.
...
- Use the EC2 service tag as the job label, with all tags prefixed with monitor_as additional target labels.
...
- Dropping all scraped labels that begin with node\_
